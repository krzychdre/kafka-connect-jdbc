...
import io.confluent.connect.jdbc.sink.transformer.SinkRecordTransformerManager;
...
public class JdbcDbWriter {
  ...
  private final SinkRecordTransformerManager transformerManager;
  ...
  JdbcDbWriter(final JdbcSinkConfig config, DatabaseDialect dbDialect, DbStructure dbStructure) {
    ...
    this.transformerManager = new SinkRecordTransformerManager();
  ...
  private void initTransformers() {
    this.transformerManager
        .addTransformer(new KafkaTimestampAppender(), config.appendKafkaTimestamp)
        .addTransformer(new KafkaOffsetAppender(), config.appendKafkaOffset);
  }
  ...
  void write(final Collection<SinkRecord> records) throws SQLException {
    ...
    for (SinkRecord rec : records) {
      ...
      SinkRecord record = transformerManager.transform(rec);
